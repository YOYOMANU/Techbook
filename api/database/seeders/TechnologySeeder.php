...
class TechnologySeeder extends Seeder
{
    ...
    // Front-end
        ...
        ['name' => 'NumPy',        'description' => 'Bibliothèque Python pour le calcul scientifique et les opérations sur les tableaux multidimensionnels.', 'categories' => ['ia & ml'],        'level' => 'intermediaire', 'status' => 'En cour'],
        ...
        ['name' => 'Nginx',        'description' => 'Serveur web et reverse proxy haute performance, souvent utilisé devant les apps Laravel/Node.',   'categories' => ['cloud & devops'],        'level' => 'intermediaire', 'status' => 'En cour'],
